...
mr = (function (mr, $, window, document){
    ...
    var documentReady = function($){
        ...
        $('.nav-mobile-toggle').on('click', function(){
            ...
            $('.header-menu').toggleClass('display-visible');
            $('.page-menu').toggleClass('display-visible');
        });
    ...
    mr.navigation.bar.update = function(){
        ...
        if( (mr.scroll.y > mr.navigation.bar.fixedAt) && !mr.navigation.bar.isFixed)
        {
            ...
            $('.header-image').addClass('display--fixed')
            $('.header-menu > li').addClass('list--fixed')
        }
        ...
        if( (mr.scroll.y < mr.navigation.bar.fixedAt) && mr.navigation.bar.isFixed)
        {
            ...
            $('.header-image').removeClass('display--fixed')
            $('.header-menu > li').removeClass('list--fixed')
        }
    };
